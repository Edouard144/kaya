    ...
    <div>
        ...
        <div className="surface-card grid gap-10 p-10 md:grid-cols-12 md:p-14">
          <div className="md:col-span-5">
            ...
            <p className="mt-4 text-muted-foreground">
              We've outfitted properties from city hotels to mountain lodges — boutique
              fit-outs through to flagship resort builds.
            </p>
            <Link to="/industries" className="mt-6 inline-flex btn-primary text-sm">See all industries →</Link>
          </div>
      ...
      <section className="container-page py-10">
        <div className="mb-8 flex items-end justify-between">
          ...
          <Link to="/projects" className="text-sm text-terracotta hover:underline">All projects →</Link>
        </div>
      ...
      <section className="container-page py-16">
        ...
        <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
          {["Radisson","Marriott","Wyndham","Hilton","IHG","Accor"].map((b) => (
            <div key={b} className="surface-card grid h-20 place-items-center font-display text-xl text-ink-soft">
              {b}
            </div>
          ))}
        </div>
      ...
      <section className="container-page pb-24">
        ...
        >
          <div className="flex items-start gap-5">
            ...
            <div>
              <div className="text-xs uppercase tracking-[0.18em] text-muted-foreground">Outfitting a property?</div>
              <h3 className="mt-2 font-display text-3xl md:text-4xl">Tell us about your project</h3>
              <p className="mt-2 max-w-xl text-muted-foreground">
                Send your room count, location and timeline — we'll respond with a tailored quote inside 48 hours.
              </p>
            </div>
          </div>
          <div className="flex flex-wrap gap-2">
            <Link to="/quote" className="btn-primary inline-flex items-center gap-2">Request quote <ArrowRight className="h-4 w-4" /></Link>
