...
export const categories: Category[] = [
  {
    ...
    blurb:
      "Hospitality-grade furniture engineered for daily use — beds, wardrobes, desks and seating that hold up to years of turnover.",
    cover: suite,
    featured: true,
    subcategories: [
      "Hotel Beds",
  ...
  },
  {
    ...
    blurb:
      "Cotton-rich sheets, towels and robes specced for industrial laundering — soft on guests, tough through cycles.",
    cover: linens,
    featured: true,
    subcategories: [
      "Bed Sheets",
  ...
  },
  {
    ...
    blurb:
      "Reception desks, waiting sofas, lounge chairs and decorative pieces that set the tone on arrival.",
    cover: lobby,
    featured: true,
    subcategories: [
      "Reception Desks",
  ...
  },
  {
    ...
    blurb:
      "Chandeliers, pendant lights and the soft furnishings that shape the atmosphere of every space.",
    cover: lobby,
    featured: true,
    subcategories: [
      "Chandeliers",
  ...
  },
  {
    ...
    blurb:
      "CCTV, smart locks, key-card systems, fire safety and room automation — the invisible layer guests trust.",
    cover: suite,
    featured: true,
    subcategories: [
      "CCTV Cameras",
  ...
  },
  {
    ...
    blurb:
      "Industrial washers and dryers, housekeeping trolleys, chemicals and the consumables that keep rooms turning.",
    cover: linens,
    featured: true,
    subcategories: [
      "Washing Machines",
  ...
  },
  {
    ...
    short: "Climate & air",
    blurb:
      "Air conditioning, ventilation, purification and heating sized for hospitality buildings.",
    cover: lobby,
    subcategories: [
      "Air Conditioners",
      "Fans",
  ...
  },
  {
    ...
    short: "Meeting & stage",
    blurb:
      "Conference furniture, AV equipment, stage and sound to outfit ballrooms and meeting halls.",
    cover: restaurant,
    subcategories: [
      "Conference Tables",
      "Meeting Chairs",
  ...
  },
  {
    ...
    blurb:
      "Smart TVs, in-room safes, mini fridges, kettles and Wi-Fi gear, ready for room-by-room rollout.",
    cover: suite,
    subcategories: [
      "Smart TVs",
      "Telephones",
  ...
  },
  {
    ...
    blurb:
      "Cement, steel, paint, plumbing and electrical materials for new builds and refurbishments.",
    cover: pool,
    subcategories: [
      "Roofing Materials",
      "Exterior Paints",
...
export const seedProducts: SeedProduct[] = [
  ...
  {
    id: "p-sheet-king",
    name: "300TC Sateen Sheet Set",
    category: "bedding-linen",
    image: imgSheetSet,
    description: "Long-staple cotton sateen, hospitality-laundering rated.",
    pricingNote:
      "Priced per set (fitted + flat + 2 pillowcases). Hotels typically stock 3 sets per room.",
    tiers: ["30+ sets", "150+ sets", "500+ sets"],
  },
  {
    id: "p-towel-bath",
    name: "600gsm Bath Towel",
    category: "bedding-linen",
    image: imgBathTowel,
  ...
  {
    id: "p-bath-tub",
    name: "Freestanding Marble Tub",
    category: "bathroom-solutions",
    image: imgMarbleTub,
    description: "Polished freestanding tub with brass mixer support.",
    pricingNote:
      "High-specification item — typically quoted individually or for suite-level rooms.",
  ...
  },
  {
    ...
    pricingNote:
      "Priced per system (head + diverter + valve). Volume tiers for full-floor fit-outs.",
  ...
  // — Commercial Kitchen —
  {
    id: "p-convection-oven",
    name: "Convection Combi Oven",
  ...
  {
    id: "p-reach-in-fridge",
    name: "Reach-In Refrigerator",
    category: "commercial-kitchen",
    image: imgReachInFridge,
  ...
  },
  {
    ...
    pricingNote:
      "Priced per unit. Cooking suite layout quoted alongside extraction and ventilation.",
    tiers: ["1–2 units", "3–5 units", "6+ units"],
  },
  ...
  // — Restaurant & Dining —
  {
    ...
    pricingNote:
      "Priced per table. F&B fit-outs are typically quoted as full dining-room packages.",
  ...
  },
  {
    ...
    pricingNote:
      "Priced per case of 24. Restaurants typically open with 3× seat-count in glass stock.",
    tiers: ["5+ cases", "20+ cases", "80+ cases"],
  },
  {
    id: "p-plate-set",
    name: "Porcelain Plate Set",
    category: "restaurant-dining",
    image: imgPlateSet,
  ...
  {
    id: "p-reception-desk",
    name: "Marble Reception Desk",
    category: "reception-lobby",
    image: imgReceptionDesk,
    description: "Custom-length marble front desk with cable management.",
    pricingNote:
      "Quoted per project — desk length and finish are configured to your lobby dimensions.",
    tiers: ["Single unit", "2–3 units", "4+ units"],
  },
  {
    id: "p-lobby-sofa",
    name: "Modular Lobby Sofa",
    category: "reception-lobby",
    image: imgLobbySofa,
  ...
  {
    id: "p-pool-lounger",
    name: "Aluminium Sun Lounger",
    category: "outdoor-pool",
    image: imgSunLounger,
    description: "Powder-coated aluminium frame with weave sling.",
    pricingNote:
      "Priced per lounger. Pool decks typically spec 2 loungers per key for resort properties.",
    tiers: ["10+ units", "40+ units", "150+ units"],
  },
  {
    id: "p-pool-umbrella",
    name: "Cantilever Pool Umbrella",
    category: "outdoor-pool",
    image: imgPoolUmbrella,
  ...
  },
  {
    ...
    category: "lighting-decoration",
    image: imgBrassPendant,
    description: "Smoked-glass pendant with brushed-brass canopy.",
    pricingNote:
      "Priced per fitting. Restaurant and corridor schemes typically use 20–100+ pendants.",
    tiers: ["10+ fittings", "40+ fittings", "120+ fittings"],
  },
  {
    id: "p-carpet-runner",
    name: "Corridor Carpet Runner",
    category: "lighting-decoration",
    image: imgCarpetRunner,
  ...
  {
    id: "p-smart-lock",
    name: "RFID Smart Lock",
    category: "security-smart",
    image: imgSmartLock,
    description: "Card and mobile-key enabled lock with audit trail.",
    pricingNote:
      "Priced per door. Full-property installs include PMS integration — quoted per project.",
  ...
  // — Swimming Pool Equipment —
  {
    ...
    image: imgPoolPump,
    description:
      "Energy-efficient variable speed pump for pools up to 120m³, whisper-quiet operation.",
  ...
  },
  {
    ...
    image: imgPoolFilter,
    description:
      "High-rate sand filter for hotel and resort pools, manual multiport valve included.",
    pricingNote: "Priced per filter. Typically paired with a pump — ask about system bundles.",
    tiers: ["1–2 units", "3–5 units", "6+ units"],
  },
  {
    id: "p-pool-light",
    name: "Underwater LED Spotlight",
    category: "swimming-pool",
    image: imgPoolLight,
    description: "12V RGB underwater spotlight, colour-changeable with remote. IP68 rated.",
    pricingNote:
      "Priced per fitting. Pools typically use 4–20 lights depending on size and design.",
  ...
  {
    id: "p-pool-ladder",
    name: "Stainless Steel Pool Ladder",
    category: "swimming-pool",
    image: pool,
  ...
  {
    id: "p-washer-25kg",
    name: "25kg Industrial Washer",
    category: "housekeeping-laundry",
    image: imgWasher,
    description: "Soft-mount industrial washer with automatic dosing.",
    pricingNote:
      "Quoted per machine. Laundry room capacity is planned based on room count and linen volume.",
  ...
  {
    id: "p-vacuum-pro",
    name: "Commercial Backpack Vacuum",
    category: "housekeeping-laundry",
    image: imgVacuum,
