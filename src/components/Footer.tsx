    ...
    <footer className="mt-24 border-t border-line/60 bg-surface-alt">
      <div className="w-full px-6 xl:px-10 grid gap-10 py-16 md:grid-cols-12">
        <div className="md:col-span-4">
          ...
          <div className="mt-6 space-y-2 text-sm">
            <div className="flex items-center gap-2 text-ink-soft">
              <MapPin className="h-4 w-4 text-terracotta" /> Tbilisi, Georgia
            </div>
            <a
              href="tel:+995000000000"
              className="flex items-center gap-2 text-ink-soft hover:text-terracotta"
            >
              <Phone className="h-4 w-4 text-terracotta" /> +995 000 000 000
            </a>
            <a
              href="mailto:hello@kaya.rent"
              className="flex items-center gap-2 text-ink-soft hover:text-terracotta"
            >
              <Mail className="h-4 w-4 text-terracotta" /> hello@kaya.rent
            </a>
          </div>

          <div className="mt-6 flex flex-wrap gap-2">
            <Link to="/quote" className="btn-primary inline-flex items-center gap-2 text-sm">
              <FileText className="h-4 w-4" /> Request quote
            </Link>
            <a href="#" className="btn-ghost inline-flex items-center gap-2 text-sm">
        ...
        <div className="md:col-span-2">
          ...
          <ul className="mt-3 space-y-2 text-sm">
            <li>
              <Link to="/about" className="text-ink-soft hover:text-terracotta">
                About Kaya
              </Link>
            </li>
            <li>
              <Link to="/projects" className="text-ink-soft hover:text-terracotta">
                Projects
              </Link>
            </li>
            <li>
              <Link to="/industries" className="text-ink-soft hover:text-terracotta">
                Industries
              </Link>
            </li>
            <li>
              <Link to="/services" className="text-ink-soft hover:text-terracotta">
                Services
              </Link>
            </li>
            <li>
              <Link to="/contact" className="text-ink-soft hover:text-terracotta">
                Contact
              </Link>
            </li>
          </ul>
